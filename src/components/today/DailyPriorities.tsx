        ...
        <div className="space-y-3">
          ...
          {priorities.length < 3 && (
            <button 
              ...
              className="w-full flex items-center gap-2 p-3 rounded-xl border-2 border-dashed border-gray-100 text-gray-400 hover:border-purple-200 hover:text-purple-600 transition-all"
            >
