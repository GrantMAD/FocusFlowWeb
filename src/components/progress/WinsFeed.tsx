  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm mt-8 transition-colors duration-300">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Your recently completed tasks and achievements.</p>
      </div>
        ...
        {wins.length === 0 ? (
          ...
          wins.map((win, i) => (
            <Link 
              key={i} 
              href="/tasks"
              className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg group hover:bg-purple-50 dark:hover:bg-purple-900/10 transition-all cursor-pointer block"
            >
